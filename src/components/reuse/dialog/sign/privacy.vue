<template>
  <el-dialog
    ...
    <div class="lordless-message-box">
      ...
      <h3 class="text-center">LORDLESS Privacy Policy</h3>
      <privacy class="dialog"/>
      <div class="text-center privacy-btns">
        <lordless-btn class="privacy-btn" theme="blue" shadow inverse @click.native="agree">Agree</lordless-btn>
